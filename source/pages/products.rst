...
.. image:: /_static/images/products/oak-d-poe.png
  :alt: OAK D POE
...
.. image:: /_static/images/products/oak-1-poe.png
  :alt: OAK 1 POE
...
.. image:: /_static/images/products/oak-d-wifi.png
  :alt: OAK D WIFI

DepthAI OAK-D WiFi (BW1098OBC_WiFi) 是 OAK-D 的修改版本，增加了 WiFi 模块。该板允许用户快速制作独立嵌入式解决方案的原型。

除了标准的 DepthAI 功能外，OAK-D WiFi 还让用户可以使用具有蓝牙、低功耗蓝牙 (BTLE) 和 WiFi 等有用功能的轻量级处理器，并提供方便的 FCC/CE 认证模块。
...
.. image:: /_static/images/products/esp32-wifi-bt.png
  :alt: ESP32 WIFI AND BT

BW1092 是 BW1098OBC 的改进版本，增加了 ESP32 系统模块 (ESP32-WROOM-32)。该板允许用户快速制作独立嵌入式解决方案的原型。

除了标准的 DepthAI 功能外，ESP32 还让用户可以使用具有蓝牙、低功耗蓝牙 (BTLE) 和 WiFi 等实用功能的轻量级处理器，并提供方便的 FCC/CE 认证模块。
