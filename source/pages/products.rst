...
因此，例如，如果您将BW1098FFC的立体基准设置为2.5cm，并且彩色摄像机恰好位于两个灰度摄像机之间，如下所示，请进一步使用以下JSON:
...
如果您对上述深度质量感到满意，则可以将其写入DephtAI上的板载eeprom，以便带有DepthAI的校准棒（所有具有双目深度支持的设计均具有板载eeprom）。
