...
此示例显示了使用立体图像从主机获取的深度图。您可以在代码内选择3种深度模式：左右检查，扩展（用于更近距离），子像素（用于更长距离）。否则，将激活kernel_7x7的中值。
...
此示例还需要数据集文件夹才能工作——您可以从 `这里 <https://drive.google.com/file/d/1mPyghc_0odGtSU2cROS1uLD-qwRU8aug>`_ 下载它。

源代码
*********************

也可以在 `GitHub <https://github.com/luxonis/depthai-python/blob/main/examples/30_stereo_depth_from_host.py>`_ 上找到。
