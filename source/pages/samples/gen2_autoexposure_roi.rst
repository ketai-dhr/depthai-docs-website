...
本示例说明如何在应用程序运行时根据边界框位置动态地动态设置RGB相机的自动曝光（AE）
...
.. raw:: html
    ...
    <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; height: auto;">
        <iframe src="http://player.bilibili.com/player.html?aid=416982794&bvid=BV1iV411v7jB&cid=304672094&page=1" frameborder="0" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
    </div>
...
也可以在 `GitHub <https://github.com/luxonis/depthai-python/blob/gen2_develop/examples/23_autoexposure_roi.py>`_ 上找到。
