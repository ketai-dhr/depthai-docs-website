...
也可以在 `GitHub <https://github.com/luxonis/depthai-python/blob/gen2_develop/examples/21_mobilenet_device_side_decoding.py>`_ 上找到。国内用户也可以在 `gitee <https://gitee.com/oakchina/depthai-python/blob/gen2_develop/examples/21_mobilenet_device_side_decoding.py>`_ 上找到。
