...
可以在 `GitHub <https://github.com/luxonis/depthai-python/blob/main/examples/mixed/mono_depth_mobilenetssd.py>`_ 上找到。国内用户也可以在 `gitee <https://gitee.com/oakchina/depthai-python/blob/main/examples/mixed/mono_depth_mobilenetssd.py>`_ 上找到。
